...
class GetAllEventViewBodyMobile extends StatefulWidget {
  const GetAllEventViewBodyMobile({super.key});

  @override
  State<GetAllEventViewBodyMobile> createState() =>
      _GetAllEventViewBodyMobileState();
}

class _GetAllEventViewBodyMobileState extends State<GetAllEventViewBodyMobile> {
